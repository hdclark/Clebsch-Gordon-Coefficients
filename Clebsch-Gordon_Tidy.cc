...
// make our own in C++.
//
// Note you might prefer std::rational if it is accepted for C++17++ (or beyond), or
// use Boost's Rational Number Library instead. This implementation works, but it not 
// efficient, clever, or even safe for large numbers.
//
...
std::map<CGCcoeff,std::vector<frac> > DetermineAllCGCs(frac j1, frac j2, frac j){
    //This routine is the core of this program. It cycles through all possible
...
/*
    //Examples for other decompositions:
